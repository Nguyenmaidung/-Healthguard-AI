...
export default function Login() {
    ...
    const { signIn, signInWithGoogle, enableGuestMode } = useAuth()
        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="glass-card p-8">
                    <h2 className="text-2xl font-bold text-white text-center mb-2">Đăng nhập</h2>
                    <p className="text-dark-400 text-center mb-6">Chào mừng bạn quay lại!</p>
                    ...
                    <div className="flex items-center gap-4 my-6">
                        ...
                        <span className="text-sm text-dark-500">hoặc</span>
                        <div className="flex-1 h-px bg-white/10"></div>
                    </div>
